...
# -------------------------------------------------
# HARD RESET STREAMLIT SPACING (IMPORTANT FIX)
# -------------------------------------------------
st.markdown("""
<style>
...
# -------------------------------------------------
st.markdown(
    "<p style='text-align:center; color:#94a3b8; margin-top:24px;'>"
